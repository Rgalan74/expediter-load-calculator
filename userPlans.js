// ===============================
// ðŸ” SISTEMA DE PLANES DE USUARIO
...
async function initializeUserPlan(userId, email) {
  try {
    ...
    console.log('âœ… Plan de usuario inicializado');
    return true;
  } catch (error) {
    console.error('âŒ Error inicializando plan:', error);
    return false;
  }
}
...
async function setUserAsAdmin(userId) {
  try {
    ...
    console.log('âœ… Usuario convertido a Admin');
    return true;
  } catch (error) {
    console.error('âŒ Error asignando admin:', error);
    return false;
  }
}
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-8">
      <div class="text-center mb-6">
        ...
        <p class="text-gray-600">
          <strong>${featureName}</strong> estÃ¡ disponible en nuestro Plan Profesional
        </p>
      </div>
      ...
      <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        ...
        <ul class="text-sm text-blue-700 space-y-1">
          <li>âœ“ Cargas ilimitadas</li>
          <li>âœ“ Sistema de finanzas completo</li>
          <li>âœ“ Cuentas por cobrar</li>
          <li>âœ“ Mapa de zonas rentables</li>
...
console.log('âœ… Sistema de planes de usuario cargado correctamente');