 ...
 * Firebase CDN tiene caché agresivo del HTML, así que lo creamos via JS
 */

(function createCategoryModalDynamic() {
    ...
    function createModal() {
        ...
        if (document.getElementById('categoryModal')) {
            console.log('✅ Modal de categorías ya existe');
            return;
        }

        console.log('🔧 Creando modal de categorías dinámicamente...');
  ...
  <div id="categoryModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    ...
    `;
        ...
        console.log('✅ Modal de categorías creado dinámicamente');
    }
})();
